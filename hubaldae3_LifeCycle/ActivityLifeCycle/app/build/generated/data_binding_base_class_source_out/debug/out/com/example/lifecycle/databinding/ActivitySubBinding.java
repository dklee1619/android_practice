...
package com.example.lifecycle.databinding;
...
public final class ActivitySubBinding implements ViewBinding {
  ...
  private ActivitySubBinding(@NonNull ConstraintLayout rootView, @NonNull Button subbutton) {
  ...
  public static ActivitySubBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.subbutton;
      Button subbutton = ViewBindings.findChildViewById(rootView, id);
      if (subbutton == null) {
        break missingId;
      }

      return new ActivitySubBinding((ConstraintLayout) rootView, subbutton);
    }
